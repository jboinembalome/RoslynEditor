namespace Settings.Internal
{
    ...
    internal class SettingsManagerImpl : ISettingsManager
    {
        ...
        {
            List<LanguageCollection> ret = new()
            {
                new LanguageCollection() { Language = "en", Locale = "US", Name = "English (English)" },
                new LanguageCollection() { Language = "de", Locale = "DE", Name = "Deutsch (German)" }
            };
            ...
            try
            {
                if (File.Exists(sessionDataFileName))
                {
                    ...
                    try
                    {
                        ...
                        XmlSerializer serializerObj = new(typeof(Profile));
