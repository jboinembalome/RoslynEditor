namespace HighlightingLib.Manager
{
	...
	using HighlightingLib.Resources;
	...
	public class ThemedHighlightingManager : IThemedHighlightingManager
	{
		...
		/// </summary>
		public const string HL_GENERIC_NAMESPACE_ROOT = "HighlightingLib.Resources.Light";
		...
		/// </summary>
		public const string HL_THEMES_NAMESPACE_ROOT = "HighlightingLib.Resources.Themes";
		...
		public IHighlightingDefinition GetDefinitionByExtension(string extension)
		{
			lock (lockObj)
			{
                if (_ThemedHighlightings.TryGetValue(CurrentTheme.Key, out IHLTheme theme) == true)
                {
		...
		/// constant (eg. 'HighlightingLib.Resources')
		/// </summary>
		/// <param name="themeNameKey"></param>
		/// <returns></returns>
		protected virtual string GetPrefix(string themeNameKey)
		{
			lock (lockObj)
			{
                if (_ThemedHighlightings.TryGetValue(themeNameKey, out IHLTheme theme) == true)
                {
																						  ...
																						  string highlightingName)
		{
			lock (lockObj)
			{
                _ThemedHighlightings.TryGetValue(hlThemeName, out IHLTheme highlighting);
