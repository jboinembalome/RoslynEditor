namespace HighlightingLib.Manager
{
	...
	internal class HLTheme : IHLTheme
	{
		...
		private readonly Dictionary<string, IHighlightingDefinition> highlightingsByName = new();
		private readonly Dictionary<string, IHighlightingDefinition> highlightingsByExtension = new(StringComparer.OrdinalIgnoreCase);
		private readonly List<IHighlightingDefinition> allHighlightings = new();
		...
		/// file xshTd can be found (eg 'HighlightingLib.Resources.Themes').
		/// </summary>
