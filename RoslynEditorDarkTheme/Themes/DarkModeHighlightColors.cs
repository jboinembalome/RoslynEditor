...
namespace RoslynEditorDarkTheme.Themes
{
    public class DarkModeHighlightColors : IClassificationHighlightColors
    {
        ...
        public HighlightingColor MethodBrush { get; protected set; } = new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(220, 220, 170)) };
        ...
        public HighlightingColor ControlKeywordBrush { get; protected set; } = new HighlightingColor { Foreground = new SimpleHighlightingBrush(Color.FromRgb(216, 160, 223)) };
